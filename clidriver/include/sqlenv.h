...
#define SQL_AUTHENTICATION_CERTIFICATE 14   /* Auth using Transport Layer     */
                                            ...
                                            /* mechanism                      */
#define SQL_AUTHN_TOKEN                15   /* Authentication using a token   */
#define SQL_AUTHN_SVR_ENCRYPT_TOKEN    16   /* Authentication using Server    */
                                            /* with Encrypt or a token        */
#define SQL_AUTHN_KERBEROS_TOKEN       17   /* Authentication using Kerberos  */
                                            /* or a token                     */
#define SQL_AUTHN_KRB_SVR_ENC_TOKEN    18   /* Authentication using Kerberos  */
                                            /* or Server with Encrypt or a    */
                                            /* token                          */
#define SQL_AUTHN_GSSPLUGIN_TOKEN      19   /* Authentication using GSS API   */
                                            /* plugin or a token              */
#define SQL_AUTHN_GSS_SVR_ENC_TOKEN    20   /* Authentication using GSS API   */
                                            /* plugin or Server with Encrypt  */
                                            /* or a token                     */
...
#define SQL_CS_BINARY          -15     /* Binary collation for Unicode (CP    */
                                       /* 1208) databases only                */
...
** 
** - SQL_CS_BINARY
** Collation sequence is strictly binary, that is, binary code point order
** with no blank padding or stripping involved.
** 
** COBOL Structure
** 
** * File: sqlenv.cbl
...
#define SQLE_RC_UPDATE_DIR_FAIL 1705         /* Fail to update directory      */
                                             /* entry                         */
#define SQLE_RC_UPGRADE_WARN 1708            /* Upgrade complete with         */
                                             /* warning code                  */

#define SQLE_RC_INVALID_NETMONCF -1786       /* The member or CF failed to    */
